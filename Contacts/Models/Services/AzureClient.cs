...
namespace Contacts
{
	public class AzureClient
	{
		...
		const string dbPath = "DavazDB";
		private const string serviceUri = "http://xcontacts.azurewebsites.net";
		...
		void createAzureClient()
		{
			if (string.IsNullOrWhiteSpace(serviceUri))
				throw new Exception("http://xcontacts.azurewebsites.net//tables/Contacts");
